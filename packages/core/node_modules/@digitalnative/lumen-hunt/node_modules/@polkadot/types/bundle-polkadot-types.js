const polkadotTypes = (function (exports, util, utilCrypto) {
  ...
  const definitions$V = {
    rpc: {},
    types: _objectSpread$q(_objectSpread$q({}, numberTypes), {}, {
  ...
  const definitions$v = {
    rpc: {},
    types: _objectSpread$p(_objectSpread$p({}, keyTypes), {}, {
  ...
  const definitions$t = {
    rpc: {},
    types: _objectSpread$o(_objectSpread$o(_objectSpread$o({}, deprecated), phragmen), {}, {
      ActiveEraInfo: {
        index: 'EraIndex',
        start: 'Option<Moment>'
      },
  ...
  const definitions$g = {
    rpc: {},
    types: _objectSpread$n({}, dmpQueue)
  };
  ...
  const slotTypes = _objectSpread$m(_objectSpread$m({}, oldTypes), {}, {
    AuctionIndex: 'u32',
  ...
  const definitions$f = {
    rpc: {},
    types: _objectSpread$l(_objectSpread$l(_objectSpread$l(_objectSpread$l(_objectSpread$l({}, cumulusTypes), hrmpTypes), proposeTypes), slotTypes), {}, {
  ...
  const definitions$c = {
    rpc: {},
    types: _objectSpread$k(_objectSpread$k(_objectSpread$k(_objectSpread$k(_objectSpread$k({}, junction), multiAsset), xcm), xmcOrder), {}, {
      DoubleEncodedCall: {
        encoded: 'Vec<u8>'
      },
      XcmOriginKind: {
  ...
  const definitions$b = {
    rpc: {},
    types: _objectSpread$j(_objectSpread$j(_objectSpread$j({}, layout), spec), {}, {
      ContractProject: {
  ...
  const rpc = _objectSpread$i(_objectSpread$i(_objectSpread$i({}, netRpc), web3Rpc), {}, {
    accounts: {
  ...
  const definitions$8 = {
    rpc: {},
    types: _objectSpread$h(_objectSpread$h(_objectSpread$h(_objectSpread$h(_objectSpread$h(_objectSpread$h(_objectSpread$h({}, v9), v10), v11), v12), v13), v14), {}, {
      //
  ...
  Object.keys(definitions).filter(key => Object.keys(definitions[key].rpc || {}).length !== 0).forEach(_section => {
    ...
    Object.entries(definitions[_section].rpc).forEach(([method, def]) => {
      ...
      jsonrpc[section][method] = _objectSpread$g(_objectSpread$g({}, def), {}, {
        isSubscription,
  ...
  function _decodeEnum(value, details, count) {
    ...
    if (Array.isArray(details)) {
      ...
      value.sub = Object.entries(details).map(([name, typeOrObj], index) => _objectSpread$f(_objectSpread$f({}, getTypeDef(getTypeString(typeOrObj || 'Null'), {
        name
      }, count)), {}, {
        index
      }));
  ...
  const infoMapping = {
    ...
    [exports.TypeDefInfo.DoNotConstruct]: (registry, value) => DoNotConstruct.with(value.displayName),
  ...
  function encodeSubTypes(sub, asEnum) {
    ...
    const inner = sub.reduce((result, type) => _objectSpread$e(_objectSpread$e({}, result), {}, {
  ...
  function encodeTypeDef(typeDef) {
    util.assert(!util.isUndefined(typeDef.info), () => `Invalid type definition with no instance info, ${util.stringify(typeDef)}`); // In the case of contracts we do have the unfortunate situation where the displayName would
  ...
  class MetadataVersioned extends Struct {
      ...
      Object.defineProperty(this, _getVersion, {
        ...
        value: (version, fromPrev) => {
          ...
          if (version !== 'latest' && _classPrivateFieldBase(this, _assertVersion)[_assertVersion](version)) {
            return _classPrivateFieldBase(this, _metadata)[_metadata]()[asCurr];
          }
    ...
    get asV9() {
      ...
      return _classPrivateFieldBase(this, _metadata)[_metadata]().asV9;
    }
    /**
    ...
    get version() {
      return _classPrivateFieldBase(this, _metadata)[_metadata]().index;
    }
